...
@onready var office_button = $OfficeButton
...
func _ready() -> void:
	...
	office_button.mouse_entered.connect(_on_office_button_mouse_entered)
	office_button.mouse_exited.connect(_on_office_button_mouse_exited)
...
func _on_office_button_mouse_entered() -> void:
	_scale_button(office_button, HOVER_SCALE)

func _on_office_button_mouse_exited() -> void:
	_scale_button(office_button, NORMAL_SCALE)
